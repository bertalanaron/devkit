...
void edit(const char* id, float& value)
...
void edit(const char* id, double& value)
...
void edit(const char* id, int& value)
...
void edit(const char* id, std::string& value)
{
...
void edit(const char* id, E& value)
{
...
template <typename E>
	requires(std::is_enum_v<E>)
E edit(const char* id, const E& value)
{
	E result = value;
	const auto names = magic_enum::enum_names<E>();
	const int index = magic_enum::enum_index(value).value_or(0);
...
template <glm::length_t L, typename T, glm::qualifier Q>
void edit(const char* id, glm::vec<L, T, Q>& vec)
{ edit<L>(id, vec.x); }
...
template <common::UniquePropertySpecialization UProperty>
	requires(std::is_scalar_v<typename UProperty::type>)
...
void edit(const char* name, Config& config)
{
